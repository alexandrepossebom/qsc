...
# Generated by qmake (2.01a) (Qt 4.6.1) on: sex jan 29 15:52:17 2010
# Project:  qsc.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/lib -lQtSql -L/usr/lib -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		conjuge.cpp \
		conjugecontroller.cpp moc_mainwindow.cpp \
...
compiler_rcc_make_all: qrc_qsc.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_qsc.cpp
qrc_qsc.cpp: qsc.qrc \
		images/qsc.png
	/usr/lib/qt4/bin/rcc -name qsc qsc.qrc -o qrc_qsc.cpp
...
conjuge.o: conjuge.cpp conjuge.h \
		cliente.h \
		nacionalidade.h \
		naturalidade.h \
		empresa.h \
		...
		endereco.h \
		estado.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o conjuge.o conjuge.cpp

conjugecontroller.o: conjugecontroller.cpp conjugecontroller.h \
		conjuge.h \
		cliente.h \
		nacionalidade.h \
		naturalidade.h \
		...
		estado.h \
		dbutil.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o conjugecontroller.o conjugecontroller.cpp
...
qrc_qsc.o: qrc_qsc.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_qsc.o qrc_qsc.cpp
