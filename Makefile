...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Tue Sep 29 15:49:40 2009
# Project:  qsc.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		formapagamento.cpp \
		formapagamentocontroller.cpp moc_mainwindow.cpp \
...
$(TARGET): ui_mainwindow.h ui_clienteaddview.h ui_vendaaddview.h ui_nacionalidadeaddview.h ui_empresaaddview.h ui_cepaddview.h ui_configuratorview.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qsc1.0.0/ && $(COPY_FILE) --parents mainwindow.h clienteaddview.h vendaaddview.h cliente.h nacionalidade.h clientecontroller.h nacionalidadeaddview.h empresaaddview.h empresacontroller.h empresa.h naturalidade.h endereco.h enderecocontroller.h estado.h estadocontroller.h nacionalidadecontroller.h cidade.h cidadecontroller.h bairro.h bairrocontroller.h cep.h cepcontroller.h tipotelefone.h tipotelefonecontroller.h cepaddview.h dbutil.h configuratorview.h formapagamento.h formapagamentocontroller.h .tmp/qsc1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp clienteaddview.cpp vendaaddview.cpp cliente.cpp nacionalidade.cpp clientecontroller.cpp nacionalidadeaddview.cpp empresaaddview.cpp empresacontroller.cpp empresa.cpp naturalidade.cpp endereco.cpp enderecocontroller.cpp estado.cpp estadocontroller.cpp nacionalidadecontroller.cpp cidade.cpp cidadecontroller.cpp bairro.cpp bairrocontroller.cpp cep.cpp cepcontroller.cpp tipotelefone.cpp tipotelefonecontroller.cpp cepaddview.cpp dbutil.cpp configuratorview.cpp formapagamento.cpp formapagamentocontroller.cpp .tmp/qsc1.0.0/ && $(COPY_FILE) --parents mainwindow.ui clienteaddview.ui vendaaddview.ui nacionalidadeaddview.ui empresaaddview.ui cepaddview.ui configuratorview.ui .tmp/qsc1.0.0/ && (cd `dirname .tmp/qsc1.0.0` && $(TAR) qsc1.0.0.tar qsc1.0.0 && $(COMPRESS) qsc1.0.0.tar) && $(MOVE) `dirname .tmp/qsc1.0.0`/qsc1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qsc1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_clienteaddview.cpp moc_vendaaddview.cpp moc_nacionalidadeaddview.cpp moc_empresaaddview.cpp moc_cepaddview.cpp moc_configuratorview.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_clienteaddview.cpp moc_vendaaddview.cpp moc_nacionalidadeaddview.cpp moc_empresaaddview.cpp moc_cepaddview.cpp moc_configuratorview.cpp
...
moc_vendaaddview.cpp: formapagamento.h \
		cliente.h \
		nacionalidade.h \
		naturalidade.h \
		empresa.h \
...
compiler_uic_make_all: ui_mainwindow.h ui_clienteaddview.h ui_vendaaddview.h ui_nacionalidadeaddview.h ui_empresaaddview.h ui_cepaddview.h ui_configuratorview.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_clienteaddview.h ui_vendaaddview.h ui_nacionalidadeaddview.h ui_empresaaddview.h ui_cepaddview.h ui_configuratorview.h
